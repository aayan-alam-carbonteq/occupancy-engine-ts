...
export function master_adjudication_user_prompt(
  ...
  return [
    ...
    "- records_read.strength is how much weight the records carry for that signal — not how confident you feel.",
    "  weak: one thin, stale or low-reliability row. moderate: a clear reading from a single source",
    "  family. strong: the same reading reappears across independent sources. Use weak with no_signal",
    "  unless a substantive record positively establishes silence.",
